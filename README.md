...
2026-09-19 회의에서 논의 안건이 정해졌습니다. 그중 스키마·로직에 영향을 준 것들입니다.

| 안건 | 결정 | 반영 위치 |
|---|---|---|
| ⑤ 매칭 승인 | 위원 정족수가 아니라 **운영팀이 나눔글 노출을 승인** | [app/matching.py](app/matching.py). 승인 단계 자체는 `.env` 의 `IUM_OFFER_APPROVAL=off` 로 끌 수 있습니다 |
| ③ 후원자 인센티브 | 1365 봉사시간·기부금 영수증 **모두 해당 없음** | 증빙 기능을 걷어냈습니다 |
| ② 인증 나눔가게 | 매칭의 조건이 아니라 **신뢰 표시** | 기존 동작 그대로입니다 |
| ④ 파일럿 성공 지표 | 기간 1개월, 제안·승인·전달을 모두 집계 | [app/routers/office.py](app/routers/office.py) 의 `PILOT_GOALS` |

나눔글은 후원자가 올린 순간 위원에게 보이지 않습니다. 운영팀이 노출을 승인해야 매칭
후보에 오릅니다 — 협의체 이름으로 나가는 물건을 먼저 거르자는 뜻입니다. 거절에는 사유가
필수이고, 그 사유는 후원자 화면에 그대로 보입니다.

## 알려진 제약 — 의도적으로 자동화하지 않은 것

- **기부금 영수증·봉사시간 증빙은 다루지 않습니다.** 위원회 결정(안건 03)입니다. 물품·서비스
  나눔은 1365 봉사시간으로 인정되지 않고, 협의체는 기부금 영수증 발급 주체가 될 수 없습니다.
  요건이 바뀌기 전까지 이 기능을 되살리지 마세요.
